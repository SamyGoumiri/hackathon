...
<body>
    ...
    <script>
        ...
        function checkAnswerFill(correct) {
            ...
            // Expanded acceptable answers for Italian accents
            const acceptableAnswers = [correctAnswer];
            
            // Handle common accent variations
            if (correctAnswer === "è") {
                acceptableAnswers.push("e");
            } else if (correctAnswer === "parlo") {
                acceptableAnswers.push("io parlo");
            } else if (correctAnswer === "vorrei") {
                acceptableAnswers.push("io vorrei");
            }
