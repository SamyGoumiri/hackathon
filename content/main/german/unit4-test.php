...
// Frage 1
if (isset($_POST['q1']) && $_POST['q1'] === 'zug') {
    $score++;
}

// Frage 2
if (isset($_POST['q2']) && $_POST['q2'] === 'nach_rechts') {
    $score++;
}

// Frage 3
if (isset($_POST['q3']) && $_POST['q3'] === 'doppelzimmer') {
    $score++;
}

// Frage 4
if (isset($_POST['q4']) && $_POST['q4'] === 'museum') {
    $score++;
}

// Frage 5
if (isset($_POST['q5']) && $_POST['q5'] === 'reisepass') {
    $score++;
}

// Frage 6
if (isset($_POST['q6']) && strtolower(trim($_POST['q6'])) === "ich habe mich verirrt") {
    $score++;
}

// Frage 7
if (isset($_POST['q7']) && $_POST['q7'] === 'flugzeug') {
    $score++;
}

// Frage 8
if (isset($_POST['q8']) && strtolower(trim($_POST['q8'])) === "was kostet es") {
    $score++;
}
...
// Frage 10
if (isset($_POST['q10']) && $_POST['q10'] === 'verspätung') {
    $score++;
}
...
<body>
    ...
    <div class="content-container">
        <h1>Unit 4 Test: Die Reisen (Traveling)</h1>
        ...
        <div class="result-container">
            ...
            <?php if ($percentage_score >= 80): ?>
                <div class="result-message success">Excellent! You're ready to travel in German-speaking countries.</div>
            <?php elseif ($percentage_score >= 60): ?>
                <div class="result-message neutral">Good job! You know the basics of traveling in German, but there's room for improvement.</div>
            <?php else: ?>
        ...
        <div class="test-container">
            <?php if (!$test_submitted): ?>
            <p>This test will assess your knowledge of transportation vocabulary, directions, hotel reservations, tourist attractions, and dealing with travel problems in German.</p>
            <p>Answer all questions to the best of your ability.</p>
            
            <form method="post" action="">
    <!-- Question 1 -->
    <div class="question-container">
        <div class="question-text">1. What is the German word for "train"?</div>
    ...
    <!-- Question 2 -->
    <div class="question-container">
        <div class="question-text">2. How do you say "to the right" in German when giving directions?</div>
        <div class="options-container">
            <div class="option">
                <input type="radio" id="q2_a" name="q2" value="a_gauche">
                <label for="q2_a">nach links</label>
            </div>
            <div class="option">
                <input type="radio" id="q2_b" name="q2" value="a_droite">
                <label for="q2_b">nach rechts</label>
            </div>
            <div class="option">
                <input type="radio" id="q2_c" name="q2" value="tout_droit">
                <label for="q2_c">geradeaus</label>
            </div>
            <div class="option">
                <input type="radio" id="q2_d" name="q2" value="en_face">
                <label for="q2_d">gegenüber</label>
            </div>
        </div>
    </div>
    ...
    <!-- Question 4 -->
    <div class="question-container">
        <div class="question-text">4. What is the German word for "museum"?</div>
        <div class="options-container">
            <div class="option">
    ...
    <!-- Question 9 -->
    <div class="question-container">
        <div class="question-text">9. Which of these words can be used for "map" in German? (Select all that apply)</div>
        <div class="options-container">
            <div class="option">
                <input type="checkbox" id="q9_a" name="q9[]" value="carte">
                <label for="q9_a">Karte</label>
            </div>
            <div class="option">
    ...
    <!-- Question 10 -->
    <div class="question-container">
        <div class="question-text">10. What is the German word for "delay" (as in a train or flight delay)?</div>
        <div class="options-container">
            <div class="option">
                <input type="radio" id="q10_a" name="q10" value="retard">
                <label for="q10_a">Verspätung</label>
            </div>
            <div class="option">
                <input type="radio" id="q10_b" name="q10" value="attente">
                <label for="q10_b">Warten</label>
            </div>
            <div class="option">
                <input type="radio" id="q10_c" name="q10" value="annulation">
                <label for="q10_c">Stornierung</label>
            </div>
            <div class="option">
                <input type="radio" id="q10_d" name="q10" value="probleme">
                <label for="q10_d">Problem</label>
            </div>
        </div>
    </div>
