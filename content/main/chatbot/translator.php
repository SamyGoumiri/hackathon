...
<head>
    ...
    <title>Esperanto - Translation Assistant</title>
</head>
<body>
    ...
    <main>
        <div class="chat-container">
            <div class="chat-header">
                <h1>Esperanto AI Language Translator</h1>
    ...
    <script>
        ...
        async function promptGemini() {
            ...
            const instruction = `Act as a translator .
            you should translate the input of the user in ${languageMap[selectedLang]}.
