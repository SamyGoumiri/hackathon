...
<head>
    ...
    <title>Esperanto - Conversation Partner</title>
</head>
<body>
    ...
    <main>
        <div class="chat-container">
            <div class="chat-header">
                <h1>Esperanto AI for Conversation</h1>
    ...
    <script>
        ...
        async function promptGemini() {
            ...
            const instruction = `Act as a professional speaker in the ${languageMap[selectedLang]} language 
discuss with the user in ${languageMap[selectedLang]}.
you should propose a theme conversation to the user.
Here is the student input: "${input}".
you should chat with the user in ${languageMap[selectedLang]}.
